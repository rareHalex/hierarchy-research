...
class Hierarchy:
    ...
    def _filter_tree(self, tree: list, remove_leaves: bool) -> typing.Tuple[typing.List, bool]:
    ...
    def get_all_synsets(self, remove_leaves: bool) -> typing.List[Synset]:
        ...
        all_synsets = unique_list(flatten_list(filtered_tree))
        return all_synsets

    def get_synset_subtree(self, parent_synset: Synset,
                           remove_leaves: bool) -> typing.List[Synset]:

        child_synsets = unique_list(flatten_list(
...
class HierarchyMetric(abc.ABC):
    ...
    def __init__(self, dataset_hierarchy,
...
class SubtreeMetric(HierarchyMetric):
    ...
    def __init__(self, dataset_hierarchy: Hierarchy,
                 num_samples: typing.Optional[int],
